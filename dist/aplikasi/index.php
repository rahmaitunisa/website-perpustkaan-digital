...
<main>
    <div class="container-fluid">
        <h2 class="mt-4">Pengaturan Website</h2>
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-5">
                        ...
                        <!-- Card Header - Dropdown -->
                            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                <h6 class="m-0 font-weight-bold text-primary">Aturan Perpus</h6>
                            </div>
                            <?php 
                                include '../config/database.php';
                            ...
                            <div class="card-body">
                                <form action="aplikasi/edit.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label>Estimasi Peminjaman: <span id="info_waktu_pinjam"><?php if (isset( $data['waktu_peminjaman'])) echo $data['waktu_peminjaman'];?> hari</span> </label>
                                    ...
                                    <div class="form-group">
                                        <label>Harga Denda Keterlambatan: <span id="info_denda_terlambat">Rp. <?php if (isset( $data['denda_keterlambatan'])) echo number_format($data['denda_keterlambatan'],0,',','.'); ?>/hari</span> </label>

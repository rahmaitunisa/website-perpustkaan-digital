        ...
        <div class="row">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="col mr-2">
                        <div class="text-xs text-white text-uppercase mb-1">Total Peminjaman Buku</div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs text-white text-uppercase mb-1">Jumlah Pustaka Perpustakaan</div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs text-white text-uppercase mb-1">Total Denda Peminjaman Buku</div>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div id="tampil_grafik_transaksi_per_bulan">
                    <!-- Grafik transaksi per bulan di load menggunakan AJAX-->
                </div>
            </div>
        </div>
    </div>

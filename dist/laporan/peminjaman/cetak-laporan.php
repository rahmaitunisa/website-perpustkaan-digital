            ...
            <div class="card-header py-3">
                <div class="row">
                    ...
                    if (isset($_GET['dari_tanggal']) && isset($_GET['sampai_tanggal'])) {
                        $dari_tanggal = date("d/m/Y", strtotime($_GET['dari_tanggal']));
                        $sampai_tanggal = date("d/m/Y", strtotime($_GET['sampai_tanggal']));
                        echo "<div>Laporan Data Peminjaman Pada Tanggal: $dari_tanggal - $sampai_tanggal</div>";
                    }
                    ?>
                    </div>
                </div>
